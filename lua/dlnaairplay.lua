...
if (operation == nil) then
    ngx.say("{\"status\":-4,\"msg\":\"lack operation\"}")
    return
end
...
res, err, errcode, sqlstate = db:query("insert into DLNA_AirPlay (mac_add, operation, operation_time, operation_long_time, operation_type) "
                                        .. "values (" .. mac_add .."," 
                                        .. operation ..",\'"
                                        .. operation_time .."\',"
                                        .. operation_long_time ..","
